...
// Prüfen ob aktueller Benutzer Superadmin-Rechte hat
$stmt = $db->prepare("SELECT user_type FROM users WHERE id = ?");
$stmt->execute([$adminId]);
$adminUser = $stmt->fetch();
$isSuperadmin = ($adminUser && $adminUser['user_type'] === 'superadmin');
?>
...
<body>
    <div class="header">
        ...
        <div class="user-info">
            <span>👋 Admin<?php echo $isSuperadmin ? ' (Superadmin)' : ''; ?></span>
    ...
    <div class="container">
        ...
        <div class="modules-grid">
            ...
            <?php if ($isSuperadmin): ?>
            <a href="security_monitoring.php" class="module-card security">
                <div class="module-header">
                    <div class="module-icon security">🛡️</div>
                    <div>
                        <div class="module-title security">Sicherheits-Monitoring</div>
                        <div class="module-subtitle">Login-Überwachung & Schutz</div>
                    </div>
                </div>
                <div class="module-description">
                    Überwachen Sie Login-Versuche, Brute-Force-Angriffe und verwalten Sie Account-Sperrungen.
                </div>
                <div class="module-status">
                    <span class="status-badge status-superadmin">🔑 Superadmin</span>
                </div>
            </a>
            <?php endif; ?>
        </div>
